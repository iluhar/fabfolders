    ...
    <div class="header-layout">
        ...
        <div class="header-nav">
            ...
            <div class="header-logo" id="header_logo_holder">
                <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" class="header-logo-link">Kosmetista</a>
            ...
            <div id="header_menu_holder" class="header-menu ">
                ...
                <ul class="main-menu">
                    ...
                    <li class="main-menu-item">
                        <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="Blogy " class="main-menu-link">Blogy </a></li>

                    <li class="main-menu-item">
                        <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="Ľudia " class="main-menu-link">Ľudia </a></li>

                    <li class="main-menu-item">
                        <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="Skupiny " class="main-menu-link">Skupiny </a></li>

                    <li class="main-menu-item">
                        <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="Katalóg " class="main-menu-link">Katalóg </a></li>

                    <li class="main-menu-item beautybaz">
                        <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="Krása  Bazár" class="main-menu-link">Krása  Bazár</a></li>
    ...
    <div class="main-menu-layout">
        ...
        <div class="feed-menu" id="feed_menu_holder">
            ...
            <ul id="feed_menu_holder_ul">
                ...
                <li><a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank">Môj zoznam príspevkov</a></li>

                <li><a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank">Zoznam príspevkov
                    <span>
                            +36
</span></a></li>

                <li><a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank">Najlepšie </a></li>

                <li><a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank">Komentáre </a></li>

                <li id="feed_search_initiator" class="feed-search"><a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" class="main-menu-create-link"><i
        ...
        <div class="user-reg-auth-avatar">
            ...
            <div class="user-reg-auth-buttons">
                ...
                <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" class="button">Vchod</a>
                <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" class="button button-register">Registrácia</a>
        ...
        <div class="topic topic-page" id="topic_div" itemscope="">
            ...
            <div class="post-title">
                ...
                <div class="post-details">
                    ...
                    <div class="post-author">
                        <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="Kate" rel="nofollow">Kate</a>
                    ...
                    <div class="post-community">
                        <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="Kozmetika pre starostlivosť" class="community ">Kozmetika pre starostlivosť
</a>
                    </div>
            ...
            <div class="content">
                <div itemprop="articleBody">
                    ...
                    <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" class="zoom">
                        <img src="img/block_1.jpg"  alt="Royal Gold Mask"
                             class="kf-pinnable-image">
                    </a>

                   Bola som deprimovaná :((( Trápila som sa 3 roky. Za ten čas som ešte viac zostarla. Pokožka ovisla, zošúverila sa, vyschla a stratila pružnosť. Viečka ovisli, priam strach a hrôza. Náhodou som zbadala reklamu:<a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank"> Royal Gold Mask</a> – vaša tvár omladne  rýchlo a účinne. Pomyslela som si, že za pokus nič nedám. Jeden nikdy nevie, a čo ak to bude predsa fungovať. Neviem prečo, ale nejako ma to nadchlo.


                    <br>
                    <br>

                    Vyskúšala som <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank"> Royal Gold Mask</a>. Môj život sa zmenil na nepoznanie!!! Popíšem to podrobnejšie. Čo o nej môžem povedať? Je veľmi kvalitná a nežná. Pleť je po nej zamatovo svieža. Použila som ju trikrát. V balení je síce len 50 gramov, ale v call centre mi tvrdili, že vystačí na niekoľko použití. Tu je balenie, v ktorom sa predáva, mne sa vidí sympatické a kompaktné.
                  ...
                  Maska má príjemnú svetlo-žltú farbu. Neviem, či to vidíte na fotografii, ale veľmi pekne sa trblieta. Je dosť možné, že to sú tie ióny zlata, ale žiadne čiastočky viditeľné nie sú. Ozaj, aj počas tuhnutia sa maska trblieta. Nie som si istá, či je to na fotografii vidno, fotografia nie je moc kvalitná. Tu snáď to trblietanie uvidíte.
                   ...
                   Vidíte, že ako tuhne, začína meniť svoj jas, ale stále sa trblieta. Na fotke je možné to vidieť. Vyzerá to veľmi pekne. Po odstránení masky na pokožke nič nezostane, žiadne stopy po trblietaní! Masku odlupujeme všetku naraz. Starostlivo a jemne.
                     <br>
                     Pokožka zosvetlela a vyhladila sa. Na pocit bola neskutočne mäkká a hladká! Vrásky na tvári sa vyhladili a pokožka sa napla. Dám sem ešte fotky, kde je moja tvár pred a po 4 násobnej aplikácii masky. Podľa mňa je to perfektný výsledok!! Bez pripomienok hodnotím masku<a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank"> Royal Gold Mask</a> na výbornú, pretože nielen odstraňuje vrásky ale sa aj jednoducho používa!
                ...
                <div id="topic_linked_products">
                    ...
                    <div class="linked-products-title"><a  href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank">Príspevky o zmetike</a>
                    </div>
            ...
            <ul class="tags">
                ...
                <li>
                    <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="Innisfree">Innisfree</a>
                </li>
                <li>
                    <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="The Saem">The Saem</a>
                </li>
                <li>
                    <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="Tony Moly">Tony Moly</a>
                </li>
                <li>
                    <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="ázijská kozmetika">ázijská kozmetika</a>
                </li>
                <li>
                    <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="kombinovaná pleť">kombinovaná pleť</a>
                </li>
                <li>
                    <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="корейская косметика">kórejská kozmetika</a>
                </li>
                <li>
                    <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="čistenie tváre">čistenie tváre</a>
                </li>
                <li>
                    <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="peeling na tvár">peeling na tvár</a>
                </li>
                <li>
                    <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="výživa pre pleť">výživa pre pleť</a>
                </li>
                <li>
                    <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="prostriedky na umývanie">prostriedky na umývanie</a>
                </li>
                <li>
                    <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="sérum na tvár">sérum na tvár</a>
                </li>
                <li>
                    <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="zvlhčenie tváre">zvlhčenie tváre</a>
                </li>
                <li>
                    <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="starostlivosť o tvár">starostlivosť o tvár</a>
                </li>
            </ul>
            ...
            <div class="postinfo-panel-wrapper">
                ...
                <ul class="postinfo-author">
                    ...
                    <li class="avatar">
                        <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="Kate" rel="nofollow"><i
            ...
            <ul>
                ...
                <li><a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank"
...
"
                ...
                <li><a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="Môj zelený čaj od Innisfree" data-catch="1"
                ...
                <li><a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="Čistenie pleti s Tony Moly" data-catch="1"
        ...
        <div class="comments">
            ...
            <a name="comments" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank"></a>
            ...
            <div class="comment" id="comment_id_2672614">
                <img src="img/e.gif" alt="+"  class="folding"
                     style="display:none;">
                <a name="comment2672614" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank"></a>
                ...
                <div class="comment-info-voting">
                    <ul class="info">
                        <li>
                            <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank">Liana</a>
                        </li>
                    </ul>

                    <ul class="comment-voting voting positive guest">

                        <li class="plus"><a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank">
                        ...
                        <li class="minus">
                            <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" class="minus"><i class="fa fa-minus"></i></a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="comment-buttons">
                    <ul>
                        <li data-userid="106318" class="kf-comment-answer"><a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" class="comment-add">Odpovedať</a></li>
                    </ul>
                </div>
            ...
            <div class="comment" id="comment_id_2672614">
                ...
                <div class="comment-info-voting">
                    <ul class="info">
                        <li>
                            <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank">GalaVictory</a>
                        </li>
                    </ul>
            ...
            <div class="comment" id="comment_id_2672614">
                ...
                <div class="comment-info-voting">
                    <ul class="info">
                        <li>
                            <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank">Mária</a>
                        </li>
                    </ul>
            ...
            <div class="comment" id="comment_id_2672614">
                ...
                <div class="comment-info-voting">
                    <ul class="info">
                        <li>
                            <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank">Linda</a>
                        </li>
                    </ul>
                ...
                <div id="comment_content_id_2672614" class="content  ">
                    <div class="text" id="comment_txt_2672614">
                        <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank">Maska</a>  je perfektná, s výsledkom som spokojná. Mínusom je však to, že v balení je jej strašne málo.
            ...
            <div class="comment" id="comment_id_2672614">
                ...
                <div class="comment-info-voting">
                    <ul class="info">
                        <li>
                            <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank">SweetGreat</a>
                        </li>
                    </ul>
                ...
                <div id="comment_content_id_2672614" class="content">
                    <div class="text" id="comment_txt_2672614">
                        <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank">Royal Gold Mask</a> je najlepšia maska akú som kedy vyskúšala! Tu je môj výsledok za TÝŽDEŇ používania!!!
            ...
            <div class="comment" id="comment_id_2672614">
                ...
                <div class="comment-info-voting">
                    <ul class="info">
                        <li>
                            <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank">Marienka</a>
                        </li>
                    </ul>
            ...
            <div class="comment" id="comment_id_2672614">
                ...
                <div class="comment-info-voting">
                    <ul class="info">
                        <li>
                            <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank">Katka </a>
                        </li>
                    </ul>
                ...
                <div id="comment_content_id_2672614" class="content  ">
                    <div class="text" id="comment_txt_2672614">
                    Veľmi ma potešilo, že<a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank"> Royal Gold Mask</a>odstraňuje vrásky z horných pier. Trvá to však dlhšie než inde. Mne to trvalo tri týždne. Ale u niekoho to môže byť menej, u niekoho viac.
            ...
            <div class="comment" id="comment_id_2672614">
                ...
                <div class="comment-info-voting">
                    <ul class="info">
                        <li>
                            <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank">Ruženka Šípková</a>
                        </li>
                    </ul>
            ...
            <div class="comment" id="comment_id_2672614">
                ...
                <div class="comment-info-voting">
                    <ul class="info">
                        <li>
                            <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank">AAnna </a>
                        </li>
                    </ul>
                ...
                <div class="re-f" id="full_comment_form_div">
                    ...
                    <form id="form_comment" onsubmit="return false;" enctype="multipart/form-data">
                        ...
                        <ul class="list-float-left margin-top-10">
                            <li>
                                <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank"  id="comment_try_unauth" name="submit_comment" class="button">
                                    Pridať
                                </a>
                            </li>
                            <li>
                                <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank"  name="submit_preview" class="button">Náhľad</a>
                            </li>
                        </ul>
                    </form>
                </div>
        ...
        <div id="posts_related_blog" class="rotated-posts no-flip">
            ...
            <ul>
                <li class="rotated-posts-item odd ">
                    <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" data-catch="1" data-category="InternalClicks" data-action="PostRelatedTopic">
            ...
            <div class="rotated-posts-more-bloggers"><a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" data-catch="1" data-category="InternalClicks"
        ...
        <div id="posts_related_community" class="rotated-posts rotated-posts-community no-flip">
            ...
            <div class="rotated-posts-more"><a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" data-catch="1" data-category="InternalClicks"
                                               data-action="PostRelatedMore">Ďalej</a>
            </div>
        </div>
    ...
    <div class="sidebar" id="sidebar" style="-webkit-backface-visibility:hidden !important;">
        ...
        <div class="block block-list">
            ...
            <ul>
                ...
                <li>
                    <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" data-catch="1" data-category="InternalClicks" data-action="BlockStreamComments">
        ...
        <div class="block block-insta block-insta-kosmetista">
            ...
            <div class="block-insta-logo">
                <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" data-catch="1" data-category="OuterClicks" data-action="InstagraLogo"
                   rel="nofollow"></a>
            ...
            <div class="block-instagram-items">
                ...
                <div class="block-instagram-item  odd">
                    <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" rel="nofollow"
        ...
        <div class="block block-list block-tags">
            ...
            <div class="block-header-link"><a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank">Všetky štítky</a>
            </div>
            ...
            <ul>
                ...
                <li><a class="w3" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="25 plus" data-catch="1" data-category="InternalClicks"
                       data-action="BlockTagsCommunity">25 plus</a></li>

                <li><a class="w2" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="Avene" data-catch="1" data-category="InternalClicks"
                       data-action="BlockTagsCommunity">Avene</a></li>

                <li><a class="w1" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="Caudalie" data-catch="1" data-category="InternalClicks"
                       data-action="BlockTagsCommunity">Caudalie</a></li>

                <li><a class="w4" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="Clarins" data-catch="1" data-category="InternalClicks"
                       data-action="BlockTagsCommunity">Clarins</a></li>

                <li><a class="w2" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="Clinique" data-catch="1" data-category="InternalClicks"
                       data-action="BlockTagsCommunity">Clinique</a></li>

                <li><a class="w1" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="Garnier" data-catch="1" data-category="InternalClicks"
                       data-action="BlockTagsCommunity">Garnier</a></li>

                <li><a class="w2" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="La Roche-Posay" data-catch="1"
                       data-category="InternalClicks" data-action="BlockTagsCommunity">La Roche-Posay</a></li>

                <li><a class="w2" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="Loccitane" data-catch="1" data-category="InternalClicks"
                       data-action="BlockTagsCommunity">Loccitane</a></li>

                <li><a class="w2" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="Lush" data-catch="1" data-category="InternalClicks"
                       data-action="BlockTagsCommunity">Lush</a></li>

                <li><a class="w1" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="Natura Siberica" data-catch="1"
                       data-category="InternalClicks" data-action="BlockTagsCommunity">Natura Siberica</a></li>

                <li><a class="w1" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="Nivea" data-catch="1" data-category="InternalClicks"
                       data-action="BlockTagsCommunity">Nivea</a></li>

                <li><a class="w2" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="Shiseido" data-catch="1" data-category="InternalClicks"
                       data-action="BlockTagsCommunity">Shiseido</a></li>

                <li><a class="w1" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="SPF 30-50" data-catch="1" data-category="InternalClicks"
                       data-action="BlockTagsCommunity">SPF 30-50</a></li>

                <li><a class="w2" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="The Body Shop" data-catch="1"
                       data-category="InternalClicks" data-action="BlockTagsCommunity">The Body Shop</a></li>

                <li><a class="w3" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="Yves Rocher" data-catch="1"
                       data-category="InternalClicks" data-action="BlockTagsCommunity">Yves Rocher</a></li>

                <li><a class="w6" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title=" ázijská kozmetika" data-catch="1"
                       data-category="InternalClicks" data-action="BlockTagsCommunity"> ázijská kozmetika</a></li>

                <li><a class="w4" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="akné " data-catch="1" data-category="InternalClicks"
                       data-action="BlockTagsCommunity">akné </a></li>

                <li><a class="w3" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="antiage kozmetika " data-catch="1"
                       data-category="InternalClicks" data-action="BlockTagsCommunity">antiage kozmetika </a></li>

                <li><a class="w2" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="antiage krém" data-catch="1"
                       data-category="InternalClicks" data-action="BlockTagsCommunity">antiage krém</a></li>

                <li><a class="w5" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="kozmetika z lekárne" data-catch="1"
                       data-category="InternalClicks" data-action="BlockTagsCommunity">kozmetika z lekárne</a></li>

                <li><a class="w5" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title=" balzam na pery" data-catch="1"
                       data-category="InternalClicks" data-action="BlockTagsCommunity"> balzam na pery</a></li>

                <li><a class="w1" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="viac to nekúpim" data-catch="1"
                       data-category="InternalClicks" data-action="BlockTagsCommunity">viac to nekúpim</a></li>

                <li><a class="w3" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="obnova tváre" data-catch="1"
                       data-category="InternalClicks" data-action="BlockTagsCommunity">obnova tváre</a></li>

                <li><a class="w3" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="sprchový gél" data-catch="1"
                       data-category="InternalClicks" data-action="BlockTagsCommunity">sprchový gél</a></li>

                <li><a class="w1" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="hygiena " data-catch="1" data-category="InternalClicks"
                       data-action="BlockTagsCommunity">hygiena </a></li>

                <li><a class="w1" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="hydrofilný olej" data-catch="1"
                       data-category="InternalClicks" data-action="BlockTagsCommunity">hydrofilný olej</a></li>

                <li><a class="w1" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="maska z hliny" data-catch="1"
                       data-category="InternalClicks" data-action="BlockTagsCommunity">maska z hliny</a></li>

                <li><a class="w2" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="deodorant" data-catch="1"
                       data-category="InternalClicks" data-action="BlockTagsCommunity">deodorant</a></li>

                <li><a class="w5" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="odlíčenie" data-catch="1" data-category="InternalClicks"
                       data-action="BlockTagsCommunity">odlíčenie</a></li>

                <li><a class="w2" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="denný krém" data-catch="1"
                       data-category="InternalClicks" data-action="BlockTagsCommunity">denný krém</a></li>

                <li><a class="w5" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="mastná pokožka" data-catch="1"
                       data-category="InternalClicks" data-action="BlockTagsCommunity">mastná pokožka</a></li>

                <li><a class="w2" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="ochrana tváre pred slnečným " data-catch="1"
                       data-category="InternalClicks" data-action="BlockTagsCommunity">ochrana tváre pred slnečným </a>
                </li>



                <li><a class="w6" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="kombinovaná pokožka" data-catch="1"
                       data-category="InternalClicks" data-action="BlockTagsCommunity">kombinovaná pokožka</a></li>

                <li><a class="w1" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="komedóny" data-catch="1" data-category="InternalClicks"
                       data-action="BlockTagsCommunity">komedóny</a></li>

                <li><a class="w5" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="kórejská kozmetika" data-catch="1"
                       data-category="InternalClicks" data-action="BlockTagsCommunity">kórejská kozmetika</a></li>

                <li><a class="w5" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="luxusná kozmetika" data-catch="1"
                       data-category="InternalClicks" data-action="BlockTagsCommunity">luxusná kozmetika</a></li>

                <li><a class="w4" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="kozmetika pre masy" data-catch="1"
                       data-category="InternalClicks" data-action="BlockTagsCommunity">kozmetika pre masy/a></li>

                <li><a class="w2" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="ručne vyrábaná kozmetika" data-catch="1"
                       data-category="InternalClicks" data-action="BlockTagsCommunity">ručne vyrábaná kozmetika</a></li>

                <li><a class="w2" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="kozmetické oleje" data-catch="1"
                       data-category="InternalClicks" data-action="BlockTagsCommunity">kozmetické oleje</a></li>

                <li><a class="w4" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="krém na okolie očí" data-catch="1"
                       data-category="InternalClicks" data-action="BlockTagsCommunity">krém na okolie očí</a></li>

                <li><a class="w3" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="krém na viečka" data-catch="1"
                       data-category="InternalClicks" data-action="BlockTagsCommunity">krém na viečka</a></li>

                <li><a class="w7" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="krém na tvár" data-catch="1"
                       data-category="InternalClicks" data-action="BlockTagsCommunity">krém na tvár</a></li>

                <li><a class="w1" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="krém na nohy" data-catch="1"
                       data-category="InternalClicks" data-action="BlockTagsCommunity">krém na nohy</a></li>

                <li><a class="w4" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="krém na ruky" data-catch="1"
                       data-category="InternalClicks" data-action="BlockTagsCommunity">krém na ruky</a></li>

                <li><a class="w4" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="telový krém" data-catch="1"
                       data-category="InternalClicks" data-action="BlockTagsCommunity">telový krém</a></li>

                <li><a class="w1" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="krém gél" data-catch="1" data-category="InternalClicks"
                       data-action="BlockTagsCommunity">krém gél</a></li>

                <li><a class="w3" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="kozmetická voda" data-catch="1" data-category="InternalClicks"
                       data-action="BlockTagsCommunity">kozmetická voda</a></li>

                <li><a class="w6" rel="tag" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="maska na tvár" data-catch="1"
                       data-category="InternalClicks" data-action="BlockTagsCommunity"></a></li>

            </ul>
            <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" class="block-link-dotted">Ukázať všetko</a>
        </div>
        ...
        <div class="block block-top">
            ...
            <ul>
                ...
                <li class="block-top-blog-posts-item-li ">
                    <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" data-catch="1" data-category="InternalClicks" data-action="BlockTopCommunity">
                ...
                <li><a class="block-link-dotted" href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" data-catch="1" data-category="InternalClicks"
        ...
        <div class="block block-top">
            ...
            <ul>
                ...
                <li class="block-top-posts-item-li ">
                    <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" data-catch="1" data-category="InternalClicks" data-action="BlockTopAll">
...
<br><br>
        ...
        <div class="r-n"><a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="Registrácia">Registrácia</a>
        </div>
    ...
    <dl>
        <dt>Informácie</dt>
        <dd><a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="O stránke
">O stránke
</a></dd>
        <dd><a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="Pravidlá">Pravidlá</a></dd>
        <dd><a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="Nápoveď
">Nápoveď
</a></dd>
        <dd><a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="Slovník">Slovník</a>
        </dd>
        <dd><a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="Pravidlá pre užívateľov">Pravidlá pre užívateľov</a></dd>
    </dl>
    <dl>
        <dt>Rubriky</dt>
        <dd><a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="Mobilná verzia">Mobilná verzia</a></dd>
        <dd><a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="Pekní ľudia">Pekní ľudia</a></dd>
        <dd><a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="Skupiny">Skupiny</a></dd>
        <dd><a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="Spoločnosti">Spoločnosti</a></dd>
        <dd><a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="Katalóg kozmetiky
">Katalóg kozmetiky</a></dd>
        <dd><a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="Kúpiť kozmetiku">Kúpiť kozmetiku</a></dd>
        <dd><a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="Najlepšie príspevky"></a></dd>
        <dd><a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="Všetky komentáre">Všetky komentáre</a></dd>
    </dl>
    <dl>
        <dt>Služby a spojenie</dt>
        <dd><a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="Spätná väzba">Spätná väzba
</a></dd>
        <dd><a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" title="Reklama a štatistika">Reklama a štatistika</a></dd>
    </dl>
    <dl class="footer-s">
        <dt>Nasledujte Kosmetistu</dt>
        <dd class="ii"><a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" rel="nofollow"
                          title="Instagram" data-category="SocialClicks" data-action="InstagramFooter"><i
                class="fa fa-insta"></i> Instagram</a></dd>
        <dd class="ib"><a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" rel="nofollow"
                          title="Facebook" data-category="SocialClicks" data-action="FacebookFooter"><i
                class="fa fa-licokniga-square"></i> Facebook</a></dd>
        <dd class="ig"><a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" rel="nofollow"
                          title="Google+" data-category="SocialClicks" data-action="GoogleFooter"><i
                class="fa fa-gugl-plus-square"></i> Google+</a></dd>
        <dd class="it"><a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" rel="nofollow"
    ...
    <p class="copyright">Pri použití materiálov zo zdroja Kosmetista ste povinný uviesť odkaz na zdroj <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank">http://kosmetista.com</a>.<br>
