...
<html lang="ro">
	...
	<body>
		<div class="out">
			...
			<div class="wrapper">
				<div class="content">
					<center><h1> POLÍTICA </h1></center>
					<center>
						 <section>
	<br>
	<h3 id="informazioni general"> 1. Generalități </h3>
	<p> Henkel este responsabil pentru faptul că este un personal de urmărire. Aflați mai multe despre informațiile care se utilizează atunci când utilizați informațiile care sunt utilizate cu protecția la pornire. </ p>
	<p> Esta Política de Valido solo este Confidențialitate la granița bazată pe Henkel și nici una dintre aplicațiile care pot fi accesate din rețeaua locală. </p>
</section>
<section>
	<br> 
	<h3 id ="dati-per-informativă IL-trattamento-dei - Personal">2. Información de prelucrare a datelor cu caracter personal </h3>
	<p> În conformitate cu legislația č.196 30. 6. 2003 (denumită în continuare "Código de Confidențialitate"), Henkel Italia Srl (Controlador de Datos) a informat că Serano procesados ​​en formato Papel que electrónicamente, en una dintre cele mai eficiente baze de date. </p>
	<ul>
		<li> Informații specifice referitoare la datele cu caracter personal referitoare la aspectele electronice și de telecomunicații avansate, sunt responsabili și la răspundere pe cei care sunt responsabili pentru furnizarea de rezerve servicii care sunt implicate, care participă la concursuri și competiții, inclusiv întrebarea preliminară. </li>
	</ul>
	<p> 
	<p> Dacă doriți să aflați mai multe, contactați furnizorul de servicii </p>
	<ul>
		<li> Prin intermediul materialelor de informare și comunicare și informații despre electrice, hârtie, telefoane, telecomunicații, telecomunicații și telecomunicații legate de produs / serviciu, de linea ENVI <br> </li>
		<li> Analiza informațiilor despre activitățile în sprijinul preferințelor consumatorilor (din informațiile de mai sus, este clar că acestea sunt întreprinderi care se angajează în traficul de servicii electrotehnice) </li>
	</ul>
	<p> Decideți că nu sunteți de acord cu parola 2, nu aveți subordonate cu partenerii de afaceri; Dacă doriți, vă rugăm să contactați reprezentantul în secțiunea 3, mass-media de comunicare subterane care nu sunt disponibile și nu ar modifica. El decide să se deranjeze și să se întoarcă la permisiunea de a obține permisiunea să nu se întâmple. </p>
	<p> Nu a fost nici un Terceros, care ar putea fi încurajate și excluse de la întrebările personale Henkel Italia, care se ocupă de inițiative în domeniul protecției mediului (de ex. Que Tienen Derecho.) Care au loc în rețetă, care este reflectată de recibirálu. Toate drepturile și obligațiile ce decurg din prezentul contract sunt incluse în anexa la acordul s Henkel Italia, indiferent de ceea ce privește aceste aspecte.</p>
</section>
<section>
	<br>
	<h3 id="sicurezza"> 3. Securitate </h3>
	<p> Henkel respectă garanțiile și măsurile de protecție care sunt în conformitate cu legile și reglementările în vigoare referitoare la protecția vieții private și de protecție împotriva abuzurilor. Henkel cu sediul la Helsinki, Helsinki. </p>
</section>
<section>
	<br>
	<h3 id = "minorenni"> 4. Tineretul</h3>
	<p> Henkel nu a raportat niciun fel de resurse personale. Scopul este ca Henkel să acorde o atenție deosebită informațiilor despre persoane care nu ar trebui să conțină informații personale. Nu lăsați nici o informație despre o persoană, o persoană necunoscută, care ar trebui să fie informată că sunt informații și informații despre mediul înconjurător. Henkel compromite eliminarea informațiilor disponibile.</p>
</section>
<section>
	<br> 
	<h3 id ="Informazioni non-personal-Raccolte-automaticamente-cookies"> 5. Informațiile nu sunt notificate în mod automat în mod automat "Cookies" </h3>
	<p> Veți primi informații despre cookie-urile cookie Política de cookies.</p>
</section>
<section>
	<br>
	<h3 id= "cancellazione-dei-DATI-personal-contatti"> 6. Ștergeți datele personale / de contact </h3>
	<p> Datele stocate vor fi șterse de către Henkel după expirarea termenilor legali și contractuali și dacă este necesar ca aceste fișiere să eșueze. </p>
	<p> În conformitate cu art. 7 din Decretul legislativ 196/2003, desigur, puteți accesa oricând datele, să solicite o schimbare, în cazul în care nu este membru al utilizatorului care este autorizat să facă acest lucru în mod direct în instrument. De asemenea, puteți să vă revocați consimțământul în ceea ce privește utilizarea sau prelucrarea datelor dvs. cu caracter personal în viitor, sau puteți obiecta împotriva utilizării ilegale. </p>
	<p> În aceste cazuri sau pentru orice alte informații referitoare la datele dvs. personale sau la lista persoanelor responsabile, vă rugăm să contactați: Henkel Consumer Size c.p. 10478 - 20110 Milano sau prin trimiterea unui e-mail la</p>
</section>
<section>
	<br>
	<h3 id = "facebook-social-plugins"> 7. Pluginuri sociale Facebook </h3>
	<p> Site-urile noastre pot include rețele de socializare facebook.com, operate de Facebook Inc., 1601 S. California Ave, Palo Alto, CA 94304, SUA ("Facebook"). </p>
	<p> Aceste suplimente se pot potrivi mai ales cu butoanele "Like" sau "Like" de pe Facebook. Dacă accesați unul dintre site-urile noastre cu acest add-on, browserul de internet se conectează direct la serverele Facebook, iar plug-in-ul apare pe ecran cu conexiunea browserului. Plug-in-ul spune serverului Facebook ce pagini a vizitat utilizatorul. </p>
	<p> Dacă un utilizator din Facebook vizitează site-ul nostru atunci când este conectat la contul său Facebook, aceste informații vor fi legate de un cont Facebook. Chiar dacă utilizați funcții suplimentare (de exemplu, faceți clic pe "Ca" sau adăugați un comentariu), informațiile vor fi asociate contului dvs. Facebook. Aflați mai multe despre modul de colectare și utilizare a datelor din Facebook, precum și despre drepturile și modalitățile de a vă proteja confidențialitatea în acest context în secțiunea Facebook privind confidențialitatea. </p>
	<p>Dacă nu doriţi să aplicaţi o vizită pe site-ul dvs. pe Facebook, trebuie să părăsiţi Facebook înainte de a vizita. </p>
</section>
</center>
				</div>
			</div>
