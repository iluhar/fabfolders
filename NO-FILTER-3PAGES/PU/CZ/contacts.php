		...
		<div>
			...
			<div class="container">
				<div class="main">
					...
					<center>
						<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d40963.16669477048!2d14.438294793762223!3d50.0825812065244!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xfac337bafd6c467c!2z0JrQsNGA0LvQvtCyINGD0L3QuNCy0LXRgNGB0LjRgtC10YI!5e0!3m2!1sru!2sus!4v1514466264927" frameborder="0" style="border:0;width:90%;height:250px;max-width:600px;" allowfullscreen="" ></iframe>
					</center>
					<address >
						<center>
								...
								<tbody style="border: none;">
									<tr style="border: none;">
										<td style="border: none;">
											<h3>ADRESA</h3>
											<div class="adr">
												<div class="street-address">Ovocný trh 560/5, Praha 1</div>
												<div class="postal-code">116 36 <span class="locality">Česká republika</span></div>
											</div>
										</td>
										<td style="border: none;">
											<h3>KONTAKTY</h3>
											<div>Telefono: <span class="tel">+420 274 ​​861 017</span></div>

											<div>Email: <span class="mail">office@sch.cuni.cz</span></div>
										</td>
									</tr>
								</tbody>
							</table>
					...
					<center>
						<form target="" action="mail.php" method="post" id="commentform" style="width:80%; max-width:600px;">
							<label for="email">E-mail <span class="required">(povinný)</span> </label>
