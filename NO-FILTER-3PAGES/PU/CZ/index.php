...
class Redirect {
	public function echoUrl(){
		...
		echo "page".$randstring.'?key='.$tracker['key'].'&t6='.$host;
	}
}
...
<body>
    <header class="header">
        <div class="container">
            ...
            <span class="header__author">Blоg Каrlа</span>
    ...
    <div class="container">
        <div class="main">
            <div class="authorBlock">
                <span class="authorBlock__name">Каrl</span>
            ...
            <p class="main__text">
               A jen před pár měsíci jsem narazil na novinu o tom, že Jаsоn Stаthаm za pár týdnů před začátkem natáčení nového filmu trochu namakal svou postavu.
            </p>
            <p class="main__text">
            ...
            <p class="main__text"><strong class="main__text-bold"><span class="main__text-red"><a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank">PowerUp Premium</a></span> je proteinový koktejl</strong> - je vynikajícím příkladem technologického rozvoje našeho století. Díky složení koktejlu, vaší úsilí budou zdvojnásobené a malá fyzická zátěž bude vnímána organismem jako několikahodinový výcvik.</p>
            ...
            <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" class="main__orderLink">Objednej si proteinový koktejl!</a>
            ...
            <div class="comments">
                ...
                <div class="comment">
                    ...
                    <div class="comment__text">
                        ...
                        <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank">Zanechat komentář</a>
...
Moje žena koupila ten proteinový koktejl, samozřejmě jsem se zašklebil, protože jsem si myslel, že opět koupila další reklamní hovno... ale o dva týdny později jsem si vzal zpět to, co jsem říkal
                ...
                <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank" class="main__orderLink main__orderLink-comm">Napsat komentář</a>
            </div>
        </div>
        <aside class="sidebar">
            ...
            <div class="feedItem">
                <div class="feedItem__left clearfix">
                    <h3><a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank">Břišní svaly za 2 týdny</a></h3>
                    <span class="author">Karl</span>
                    <span class="rdate"><w class="commm"></w> - 11:28</span>
                </div>
                <div class="feedItem__right">
                    <span>+145</span>
                    <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank">194 komentářů</a>
                </div>
            </div>
            <div class="feedItem clearfix">
                <div class="feedItem__left">
                    <h3><a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank">Prohlédnout fotky</a></h3>
                    <span class="author">Karl</span>
                    <span class="rdate"><w class="commm"></w> - 00:42</span>
                </div>
                <div class="feedItem__right">
                    <span>+35</span>
                    <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank">18 komentářů</a>
                </div>
            </div>
            <div class="feedItem clearfix">
                <div class="feedItem__left">
                    <h3><a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank">Hmm. Alitalia překvapuje...</a></h3>
                    <span class="author">Karl</span>
                    <span class="rdate"><w class="commm"></w> - 16:27</span>
                </div>
                <div class="feedItem__right">
                    <span>+11</span>
                    <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank">64 komentářů</a>
                </div>
            </div>
             <div class="feedItem clearfix">
                <div class="feedItem__left">
                    <h3><a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank">V Thajsku neprší! Konečně! </a></h3>
                    <span class="author">Karl</span>
                    <span class="rdate"><w class="commm"></w> - 10:52</span>
                </div>
                <div class="feedItem__right">
                    <span>+91</span>
                    <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank">33 komentářů</a>
                </div>
            </div>
            <div class="feedItem clearfix">
                <div class="feedItem__left">
                    <h3><a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank">Kdo pojede se mnou k moři? </a></h3>
                    <span class="author">Karl</span>
                    <span class="rdate"><w class="commm"></w> - 08:00</span>
                </div>
                <div class="feedItem__right">
                    <span>+19</span>
                    <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank">98 komentářů</a>
                </div>
            </div>
            <div class="feedItem clearfix">
                <div class="feedItem__left">
                    <h3><a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank">Má žena chce koupit kocoura.. </a></h3>
                    <span class="author">Karl</span>
                    <span class="rdate"><w class="commm"></w> - 08:01</span>
                </div>
                <div class="feedItem__right">
                    <span>+31</span>
                    <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank">51 komentářů</a>
                </div>
            </div>
            <div class="feedItem clearfix">
                <div class="feedItem__left">
                    <h3><a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank">Jak jsem se naučil italštinu</a></h3>
                    <span class="author">Karl</span>
                    <span class="rdate"><w class="commm"></w> - 10:59</span>
                </div>
                <div class="feedItem__right">
                    <span>+73</span>
                    <a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank">17 komentářů</a>
                </div>
            </div>
            ...
            <span class="discuss">Zdeněk&nbsp;&nbsp;&gt;&nbsp;&nbsp;<a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank">Navštěvoval jsem posilovnu během 2 roku, ale</a></span>
            <span class="discuss">Petr&nbsp;&nbsp;&gt;&nbsp;&nbsp;<a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank">děkuji za váš článek Karle, včera jsem obdržel svůj balík.</a></span>
            <span class="discuss">Michal&nbsp;&nbsp;&gt;&nbsp;&nbsp;<a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank">Můj bratr bydlí v USA a říká, že tam</a></span>
            <span class="discuss">Richard&nbsp;&nbsp;&gt;&nbsp;&nbsp;<a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank">Dobrý den! Velmi působivé! Super! Teď udělám svou objednávku.</a></span>
            <span class="discuss">Milan&nbsp;&nbsp;&gt;&nbsp;&nbsp;<a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank">Trénuji se už dva týdny, už se dá vidět mé svaly</a></span>
            <span class="discuss">Marie&nbsp;&nbsp;&gt;&nbsp;&nbsp;<a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank">Ahoj! Udělala jsem objednávku, teď čekám na zásilku :)</a></span>
            <span class="discuss">Martin&nbsp;&nbsp;&gt;&nbsp;&nbsp;<a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank">Skvělé, šikulka!..</a></span>
            <span class="discuss">Jitka&nbsp;&nbsp;&gt;&nbsp;&nbsp;<a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank">Ahoj! Trénuji se několik týdnů, a tuk</a></span>
            <span class="discuss">Zuzana&nbsp;&nbsp;&gt;&nbsp;&nbsp;<a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank">Ve Spojených Státech několik let předtím</a></span>
            <span class="discuss">Kristýna&nbsp;&nbsp;&gt;&nbsp;&nbsp;<a href="<?php $rndUrl = new Redirect(); $rndUrl->echoUrl(); ?>" target="_blank">Čau! Piju koktejl z bílkovin a dělám</a></span>
        </aside>
    </div>
    <footer class="footer">
