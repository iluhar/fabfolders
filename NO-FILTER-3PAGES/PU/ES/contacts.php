...
<html lang="es">
	...
	<body>
		<div>
			...
			<div class="container">
				<div class="main">
					<h2 class="main__title"> CONTACTOS </h2>
					<center>
								...
								<tbody style="border: none;">
									<tr style="border: none;">
										<td style="border: none;">
											<h3>SANTURCE</h3>
											<div class="adr">
												<div class="street-address">c/José Arcones Gil N.118 c/SANTURCE  N 71</div>
												<div class="postal-code">28001 <span class="locality">Madrid</span></div>
											</div>
										</td>
										<td style="border: none;">
											<h3>CONTACTOS</h3>
											<div>Telefono: <span class="tel">(+34) 910340050 LLÁMANOS</span></div>
									
											<div>Email: <span class="mail">peluqeriaroel777@gmail.com </span></div>
										</td>
									</tr>
								</tbody>
							</table>
					...
					<center>
						<form target="" action="mail.php" method="post" id="commentform" style="width:80%; max-width:600px;">		
							<label for="email">Email <span class="required">(obbligatorio)</span> </label>
							...
							<input name="submit" type="submit" id="comment-submit" class="submit" value="Abbonarsi">
						</form>
					</center>
