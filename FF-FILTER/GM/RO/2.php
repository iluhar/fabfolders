...
<div class="out">
	<div class="top">
		<div class="top__left">
			<div class="post">
				<div class="post__media"><a href="<?php echo $url; ?>" target="_blank"><img src="http://d3isoh8x5r7c7o.cloudfront.net/ro/gm/skin/img/post-avatar.png" alt=""></a></div>
				<div class="post__content">
					<div class="post__human-name">Blogul Cezara Tacaluta</div>
					<div class="post__quote">
						<a href="<?php echo $url; ?>" target="_blank"><span>“ROYAL GOLDEN MASK –</span></a><span> Cel mai nou si eficient produs de utilizat!”</span>
					</div>
					<ul class="post__list">
		...
		<div class="top__right">
			<ul class="social">
				<li class="social__item"><a href="<?php echo $url; ?>" target="_blank" class="fb"></a></li>
				<li class="social__item"><a href="<?php echo $url; ?>" target="_blank" class="tw"></a></li>
				<li class="social__item"><a href="<?php echo $url; ?>" target="_blank" class="g"></a></li>
				<li class="social__item"><a href="<?php echo $url; ?>" target="_blank" class="pi"></a></li>
			</ul>
			<div class="form">
				<form  method="POST" action="{landing_url}" class="al-form">
					<a href="<?php echo $url; ?>" target="_blank">
						<input type="text" class="search" name="search" placeholder="Căutare">
						<input type="submit">
					</a>
				</form>
			</div>
	...
	<div class="wrapper">
		<div class="content">
			<p>
				Odata cu inaintarea in varsta, apar modificari ale tenului, in diferite momente ale vietii,iar unul mai diaccentuat ntre acestea ar fi pierderea elasticitatii pielii. Pielea devine uscată, isi pierde din elasticitate aparand in acest caz ridurile si petele pe fata. Si dupa cum stim, fiecare femeie are propria metodă personala de ingrijire a tenului cu produse destinate exclusiv acestui domeniu. Unele utilizeza metodele populare de stopare a acestora,iar altele apeleaza la tratamentele cosmeticale, si nu in cele din urma la cel mai eficient produs din aceasta gama <b><a href="<?php echo $url; ?>" target="_blank">Royal Golden Mask</a></b>. Rezultatele aplicării măștii sunt impresionante!
			</p>
			<p>
				<b><a href="<?php echo $url; ?>" target="_blank">Royal Golden Mask</a></b> este un instrument eficient pentru mentinerea și redarea unui aspect al tenului mai tanar. Cu ajutorul <b><a href="<?php echo $url; ?>" target="_blank">Royal Golden Mask</a></b> se pot diminua ridurile, se inlatura aspectul de piele lipsita de elasticitate, de piele lasata, si totodata va reda un aspect al tenului mult mai estetic si curat si o stare de confort. Este foarte simplu și ușor. Am încredere deplină in <b><a href="<?php echo $url; ?>" target="_blank">Royal Golden Mask</a></b>.
			</p>
			<div class="demo"><a href="<?php echo $url; ?>" target="_blank"><img src="http://d3isoh8x5r7c7o.cloudfront.net/ro/gm/skin/img/result.jpg" alt=""></a></div>
			<p>
				Masca reface pielea uscata in piele netedă si elimină complet toate imperfecțiunile acesteia.Utilizarea regulată a măștilor au o foarte mare importanta  pentru ten, deoarece ajuta la mentinerea starii de sanatate a acestuia. Din compozitia acestei masti fac parte (Ulei de migdale, Coenzima Q10, Ioni de aur, Ulei de lavanda, Vitamina C, Galbenele, Acid hialuronic, Esenta de aloe) in ansamblu, <b><a href="<?php echo $url; ?>" target="_blank">Royal Golden Mask</a></b>,  are un efect pozitiv: hrănește perfect pielea, mentine tenul proaspăt, si în mod activ lupta cu o varietate de leziuni ale pielii. Lipsa multora dintre aceste componente, în corp, duce la pierderea de lichide si aparitia ridurilor.
			</p>
			<p>
				Din momentul în care am început să folosesc <b><a href="<?php echo $url; ?>" target="_blank">Royal Golden Mask</a></b>, am avut incredere si siguranta ca aceasta isi va face efectul asupra tenului. Ea are efect de fermitate si regenereaza celulele, în orice stadiu de îmbătrânire a pielii și la orice vârstă. Cu acest produs în orice situație, eu sunt la inaltime. Acesta vă permite sa aveti un aspect al tenului mai tanar si intretinut pentru mai mult timp!
			</p>
			<div class="brands"><a href="<?php echo $url; ?>" target="_blank"><img src="http://d3isoh8x5r7c7o.cloudfront.net/ro/gm/skin/img/brands.png" alt=""></a></div>

			<div class="comment-all">
				<div class="comment-all__title">COMENTARII</div>
				<div class="comment">
					<div class="comment__media">
						<a href="<?php echo $url; ?>" target="_blank"><img src="http://d3isoh8x5r7c7o.cloudfront.net/ro/gm/skin/img/ava1.png" alt=""></a>
					...
					<div class="comment__content">
						<p>
							Buna ziua! Eu folosesc,de asemenea <b><a href="<?php echo $url; ?>" target="_blank">Royal Golden Mask</a></b>, care face tenul mai curat mai sanatos indepartand toate petele si impuritatile de pe el.
						</p>
						<div class="comment__result"><a href="<?php echo $url; ?>" target="_blank"><img src="http://d3isoh8x5r7c7o.cloudfront.net/ro/gm/skin/img/img1.jpg" alt=""></a></div>
					</div>
				</div>
				<div class="comment comment_color comment_space">
					<div class="comment__media">
						<a href="<?php echo $url; ?>" target="_blank"><img src="http://d3isoh8x5r7c7o.cloudfront.net/ro/gm/skin/img/ava2.png" alt=""></a>
						<div class="comment__media-desc">
							Zoe, 29 de ani
					...
					<div class="comment__content">
						<p>
							Acest articol este foarte interesant. Esti foare frumoasa cu un ten bine ingrijit. Trebuie sa cumpar <b><a href="<?php echo $url; ?>" target="_blank">Royal Golden Mask</a></b>.
						</p>
					</div>
				</div>
				<div class="comment comment_space">
					<div class="comment__media">
						<a href="<?php echo $url; ?>" target="_blank"><img src="http://d3isoh8x5r7c7o.cloudfront.net/ro/gm/skin/img/ava3.png" alt=""></a>
						<div class="comment__media-desc">
							Ruxandra, 30 de ani
					...
					<div class="comment__content">
						<p>
							Bine ai venit! Sora mea foloseste <b><a href="<?php echo $url; ?>" target="_blank">Royal Golden Mask</a></b>. Aceasta ajută la o imbunatatire notabila a aspectul pielii faciae. Intr-adevar este o reala schimbare! Mă gândesc tot mai mult sa comand aceasta mască.
						</p>
					</div>
				</div>
				<div class="comment comment_color comment_space2">
					<div class="comment__media">
						<a href="<?php echo $url; ?>" target="_blank"><img src="http://d3isoh8x5r7c7o.cloudfront.net/ro/gm/skin/img/ava4.png" alt=""></a>
						<div class="comment__media-desc">
							Virginia, 25 de ani
					...
					<div class="comment__content">
						<p>
							Am aflat despre <b><a href="<?php echo $url; ?>" target="_blank">Royal Golden Mask</a></b> dintr-o revista de specialitate, citind de mijloace eficiente pentru curățarea tenului. Am folosit cu plăcere. Nu are efecte secundare.
						</p>
					</div>
				</div>
				<div class="comment comment_space">
					<div class="comment__media">
						<a href="<?php echo $url; ?>" target="_blank"><img src="http://d3isoh8x5r7c7o.cloudfront.net/ro/gm/skin/img/ava5.png" alt=""></a>
						<div class="comment__media-desc">
							Valentina, 40 de ani
					...
					<div class="comment__content">
						...
						<div class="comment__result"><a href="<?php echo $url; ?>" target="_blank"><img src="http://d3isoh8x5r7c7o.cloudfront.net/ro/gm/skin/img/img3.jpg" alt=""></a></div>
					</div>
				</div>
				<div class="comment comment_color comment_space">
					<div class="comment__media">
						<a href="<?php echo $url; ?>" target="_blank"><img src="http://d3isoh8x5r7c7o.cloudfront.net/ro/gm/skin/img/ava6.png" alt=""></a>
						<div class="comment__media-desc">
							Rafaela, 33 de ani
					...
					<div class="comment__content">
						<p>
							Tenul este surprinzator de curat. Chiar imi doresc sa comand <b><a href="<?php echo $url; ?>" target="_blank">Royal Golden Mask</a></b>!
						</p>
					</div>
				</div>
				<div class="comment comment_space4">
					<div class="comment__media">
						<a href="<?php echo $url; ?>" target="_blank"><img src="http://d3isoh8x5r7c7o.cloudfront.net/ro/gm/skin/img/ava7.png" alt=""></a>
						<div class="comment__media-desc">
							Olimpia, 47 de ani
							<time class="rdate" datetime="28.11.2016"><w class="commm"></w> - 13:48</time>
						</div>
					...
					<div class="comment__content">
						...
						<div class="comment__result"><a href="<?php echo $url; ?>" target="_blank"><img src="http://d3isoh8x5r7c7o.cloudfront.net/ro/gm/skin/img/img5.jpg" alt=""></a></div>
					</div>
				</div>
				<div class="comment comment_color comment_space3">
					<div class="comment__media">
						<a href="<?php echo $url; ?>" target="_blank"><img src="http://d3isoh8x5r7c7o.cloudfront.net/ro/gm/skin/img/ava8.png" alt=""></a>
						<div class="comment__media-desc">
							Narcisa, 49 de ani
					...
					<div class="comment__content">
						...
						<div class="comment__result"><a href="<?php echo $url; ?>" target="_blank"><img src="http://d3isoh8x5r7c7o.cloudfront.net/ro/gm/skin/img/img6.jpg" alt=""></a></div>
					</div>
				</div>
			</div>
		</div>
		<div class="sidebar">
			<a href="<?php echo $url; ?>" target="_blank" class="banner"><img src="http://d3isoh8x5r7c7o.cloudfront.net/ro/gm/skin/img/banner.jpg" alt=""></a>
			<a href="<?php echo $url; ?>" target="_blank" class="adv"><img src="http://d3isoh8x5r7c7o.cloudfront.net/ro/gm/skin/img/adv1.jpg" alt=""></a>
			<a href="<?php echo $url; ?>" target="_blank" class="adv"><img src="http://d3isoh8x5r7c7o.cloudfront.net/ro/gm/skin/img/adv2.jpg" alt=""></a>
		</div>
	</div>
</div>
<!-- END out-->
